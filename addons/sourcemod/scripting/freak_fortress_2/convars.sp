...
void ConVar_PluginStart()
{
	...
	Cvar[CaptureDomeStyle] = CreateConVar("ff2_game_capture_dome_style", "1.0", "Determines how the dome would work, 0 = default behavior, 1 = normal capture", _, true, 0.0, true, 1.0);
